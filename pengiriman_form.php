...
$result = mysqli_query($conn, "SELECT * FROM pembayaran WHERE id_pembayaran='$id'");
...
if(isset($_POST['resi'])){
    ...
    $koneksi = mysqli_query($conn, "INSERT INTO pengiriman (id_pembayaran,id_pegawai, tgl_pengiriman, 
                            status_pengiriman) VALUES ('$id_pembayaran','$id_pegawai','$tgl_pengiriman',
                            '$status_pengiriman') ");

    //update status transaksi jadi detail, update status pembayaran jadi kirim dan nota
    $koneksi = mysqli_query($conn, "UPDATE pembayaran SET status_pembayaran=0 WHERE id_pembayaran='$id_pembayaran' ");
    //jika query update sukses
    if($koneksi){
  
    echo 'Data berhasil di simpan! ';  //Pesan jika proses simpan sukses
    header("location:pengiriman.php"); //membuat Link untuk kembali ke halaman edit
            ...
            <div class="sidebar-wrapper active" style="background-color: #9cd9ea;" >
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                        <img src="assets/images/logo/ss.png">
                        </div>
                        <div class="toggler">
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Form Pengiriman
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Isi Data Pengiriman</h4>
                            </div>
                            <div class="card-body col-md-4 offset-md-4 py-4">
                              
                            <form action="pengiriman_form.php" method="post">

                                <div class="form group">
                                    <label>ID Pembayaran</label>
                                    <input type="text" class="form-control" name="id_pembayaran" value="<?=$data['id_pembayaran']?>" readonly>
                                </div>
                                ...
                                <div>
                                    <input type="submit" name="resi" class="btn btn-secondary rounded-pill"></a>
                                </div> 
                            </form>
