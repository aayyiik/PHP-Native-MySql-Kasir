...
// $result= mysqli_query($conn,"SELECT a.id_pembayaran, b.id_pemesanan
// FROM pembayaran AS a
// JOIN detail_pemesanan AS b ON (a.id_pemesanan=b.id_pemesanan)
// WHERE id_pembayaran = '$id' ");
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Nota
                                        </li>
                                    </ol>
                                </nav>
                            </div>
