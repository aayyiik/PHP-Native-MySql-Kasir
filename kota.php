...
if(isset($_POST['tambahkota'])){
    ...
    $insert = mysqli_query($conn, "INSERT INTO kota (id_kota, id_prov, nama_kota)  
    VALUES (null,'$id_prov','$nama_kota')
    ");
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Tabel Kota</h4>
                                 ...
                                 <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" >
                                   <i class="bi bi-plus"></i> Tambah Kota
                                </button>
                            </div>
                            <div class="card-body">
                           ...
                           <tbody>
                               ...
                               <?php
                                       $ambildatakota = mysqli_query($conn,"SELECT * FROM kota as a JOIN provinsi as b ON (a.id_prov=b.id_prov)
                                       ");
                                       while($data=mysqli_fetch_array($ambildatakota)){ 
                                   ...
                                   <tr>
                                       ...
                                       <td><?=$nama_kota;?></td>
                                       <td>
                                           <a href="kota_edit.php?id=<?=$id_kota;?>" type="button" class="btn btn-outline-warning">Edit</a>
                                           
                                                 
                                           <a href="kota_delete.php?id=<?=$id_kota;?>" type="button" class="btn btn-outline-danger">Delete</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Tambah Kota Baru</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" name="tambahkota"></button>
      </div>
      ...
      <select name="id_prov" class="form-control mt-4">
          <?php
      ...
      <input type="text" name="nama_kota" class="form-control mt-4" placeholder="Kota">
      </div>

      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="submit" name="tambahkota" class="btn btn-info" value="tambahdata" >Submit</button>
