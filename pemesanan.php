                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Transaksi</h3>
                                <p class="text-subtitle text-muted">dua tiga mangga muda, ayo beli domba</p>
                            </div>
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Transaksi Domba
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Data Transaksi</h4>
                                 <a href="detail_pemesanan.php" type="button" class="btn btn-primary"><i class="bi bi-plus">tambah pesanan</i></a>
                            </div>
                            <div class="card-body">
                            <table class="table table-striped" id="table2">
                                ...
                                <tbody>
                                    <?php
                                            $ambildatapemesanan = mysqli_query($conn, "SELECT * FROM pemesanan as a 
                                            JOIN pegawai as b ON (a.id_pegawai=b.id_pegawai)
                                            JOIN pelanggan as c ON (a.id_pelanggan=c.id_pelanggan)
                                            JOIN kota as d ON (a.id_kota=d.id_kota)" );

                                            while($data=mysqli_fetch_array($ambildatapemesanan)){ 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if($status_transaksi==1){ ?>
                                                    <span class="badge bg-light-danger">Belum Dikonfirmasi</span>
                                               <?php }else{ ?>
                                                <span class="badge bg-light-success">Sudah Dikonfirmasi</span>
                                                <?php
                                                }
                                                ?>
                                            </td>
                                            ...
                                            <a href="pembayaran_form.php?id=<?=$id_pemesanan;?>" type="button" class="btn btn-outline-success">Bayar</a>

                                          
                                            </td>
                                            <?php else: ?>
                                                <a href="pemesanan_detail.php?id=<?=$id_pemesanan;?>" type="button" class="btn btn-outline-warning">Detail</a>
                                        <?php endif ?>
                                        </tr>
                                        <?php
                                          };
