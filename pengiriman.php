                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Pengiriman
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                            ...
                                            <?php
                                            $ambildatapengiriman = mysqli_query($conn,"SELECT * FROM pengiriman as a 
                                            JOIN pegawai as b ON (a.id_pegawai=b.id_pegawai)
                                            JOIN pembayaran as c ON (a.id_pembayaran=c.id_pembayaran)");

                                            while($data=mysqli_fetch_array($ambildatapengiriman)){ 
                                            ...
                                            <tr>
                                                    ...
                                                    if($status_pengiriman==1){?>
                                                        <span class="badge bg-light-secondary">Proses</span>
                                                       <?php }else{ ?>
                                                    ...
                                                    <td>
                                                        <a href="pengiriman_delete.php?id=<?=$no_resi;?>" type="button" class="btn btn-outline-danger">Delete</a>
                                                    </td>
                                            </tr>
                                                <?php
                                                };
