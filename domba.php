...
if(isset($_POST['tambahdomba'])){
    ...
    $insert = mysqli_query($conn, "INSERT INTO domba (id_domba, id_jenis, jenis_kelamin, harga, berat, status_domba)  
    VALUES (null,'$id_jenis','$jenis_kelamin','$harga','$berat','$status_domba')
    ");
                    ...
                    <div class="page-title">
                        <div class="row">
                            ...
                            <?php if(isset($_SESSION['sukses']) && $_SESSION['sukses'] != '') { ?>
                                <div class="alert alert-success"><i class="bi bi-check-circle">
                                </i><?=$_SESSION['sukses']?>
                                </div>
                            <?php } 
                                $_SESSION['sukses'] = '';
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Domba
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Table Domba</h4>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" >
                                   <i class="bi bi-plus"></i> Tambah Domba
                                </button>
                            </div>
                            <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                            $ambildatadomba = mysqli_query($conn,"SELECT * FROM domba JOIN jenis_domba ON domba.id_jenis = jenis_domba.id_jenis");
                                            while($data=mysqli_fetch_array($ambildatadomba)){ 
                                                $id_domba = $data['id_domba'];
                                                $jenis_domba = $data['jenis_domba'];
                                                $jenis_kelamin = $data['jenis_kelamin'];
                                                $harga = $data['harga'];
                                                $berat = $data['berat'];
                                                $status_domba = $data['status_domba'];
                                            ?>
                                        <tr>
                                            <td><?=$id_domba;?></td>
                                            <td><?=$jenis_domba;?></td>
                                            ...
                                            <td>
                                                <?php
                                                if($status_domba==1){ ?>
                                                <span class="badge bg-light-success">Ada</span>
                                                  
                                               <?php }else{ ?>
                                                <span class="badge bg-light-danger">Terjual</span>
                                                <?php
                                                }
                                                ?>
                                            </td>
                                            ...
                                            <td>
                                                <a href="domba_edit.php?id=<?=$id_domba;?>" type="button" class="btn btn-outline-warning">Edit</a>
                                                
                                                      
                                                <a href="domba_delete.php?id=<?=$id_domba;?>" type="button" class="btn btn-outline-danger">Delete</a>
                    ...
                    <div class="footer clearfix mb-0 text-muted">
                        ...
                        <div class="float-end">
                            <p>Crafted with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
                                by <a href="https://ahmadsaugi.com">Ayik</a></p>
                        </div>
                    </div>
                </footer>
            </div>
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="domba.php" method="post">

      <!-- Modal body -->
      <div class="modal-body">
      <!-- <input type="text" name="id_domba" class="form-control mt-4" placeholder="id domba"> -->
      <select name="id_jenis" class="form-control mt-4">
          <?php
          $getjenis = mysqli_query($conn,"SELECT * FROM jenis_domba");
          while($jd=mysqli_fetch_array($getjenis)){
            $id_jenis = $jd['id_jenis'];  
            $jenis_domba=$jd['jenis_domba'];
